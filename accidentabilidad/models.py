...
class Accidentabilidad(models.Model):
    ...
    basic_cause = models.ForeignKey(CausaBasica,on_delete=CASCADE,null=True,blank=True, verbose_name="Causa basica")
    ...
    inability_days = models.IntegerField('Dias de incapacidad', default=0, null=True, blank=True)
