...
class Empresa(models.Model): ## Clase que se usara para la creación de las empresas
    ...
    ciudad = models.CharField(verbose_name='Ciudad', max_length=255, null=False, blank=False, default="No indicada")
    departamento = models.CharField(verbose_name='Departamento', max_length=255, null=False, blank=False, default="No indicado")
...
class Empleado(models.Model): ## Clase destinadad a la creación de los empleados
    ...
    sufre_enfermedad = models.CharField(verbose_name="Sufre Alguna Enfermedad",max_length=255, choices=SufrEnfermedad, default="No indicado")
    cual_enfermedad = models.CharField(verbose_name="Que enfermedad Sufre?",max_length=255, default="No indicada")
    toma_medicamentos = models.CharField(verbose_name="Toma Medicamentos?",max_length=255, choices=TomaMedicamentos, default="No indicado")
    cual_medicamento = models.CharField(verbose_name="Que Medicamento toma?",max_length=255, default="No indicado")
    tipo_contrato = models.CharField(verbose_name="Tipo Contrato",max_length=255, choices=Contrato, default="No indicado")
    ...
    fecha_retiro = models.DateField(verbose_name="Fecha de Retiro", auto_now=False)
    create_at = models.DateField(auto_now_add=True, verbose_name="Creado el", null=True)
    modify_at = models.DateField(auto_now=True, verbose_name="Actualizado el")
